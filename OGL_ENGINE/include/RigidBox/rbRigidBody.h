...
public:
    ...
    struct State
    {
        ...
        State()
            : position(rbReal(0), rbReal(0), rbReal(0)), orientation(rbReal(1), 0, 0,
                                                                     0, rbReal(1), 0,
                                                                     0, 0, rbReal(1)),
              linear_velocity(rbReal(0), rbReal(0), rbReal(0)), angular_velocity(rbReal(0), rbReal(0), rbReal(0)), force(rbReal(0), rbReal(0), rbReal(0)), torque(rbReal(0), rbReal(0), rbReal(0)), angular_momentum(rbReal(0), rbReal(0), rbReal(0)), inv_inertia_world(rbReal(1), 0, 0,
                                                                                                                                                                                                                                                                         0, rbReal(1), 0,
                                                                                                                                                                                                                                                                         0, 0, rbReal(1))
        {
        }
    ...
    struct SolverWorkArea
    {
        ...
        SolverWorkArea()
            : delta_linear_velocity(0, 0, 0), delta_angular_momentum(0, 0, 0), delta_angular_velocity(0, 0, 0)
        {
        }
    ...
    struct Shape
    {
        ...
        Shape()
            : half_extent(rbReal(1), rbReal(1), rbReal(1)), inv_mass(rbReal(1)), inv_inertia(rbReal(1), 0, 0,
                                                                                             0, rbReal(1), 0,
                                                                                             0, 0, rbReal(1)),
              restitution_coefficient(rbReal(0.5)), friction_coefficient(rbReal(0.5))
        {
        }
    ...
    struct SleepStatus
    {
        ...
        SleepStatus()
            : On(false), GoSleepThresholdLV(rbReal(0.03)), GoSleepThresholdAV(rbReal(0.03)), WakeUpThresholdLV(rbReal(1.0)), WakeUpThresholdAV(rbReal(1.0)), GoSleepDuration(rbReal(0.5)), SleepingDuration(0)
        {
        }
    ...
    rbRigidBody()
        : state(), shape(), solver_work_area(), sleep_status(), attribute(Attribute_None)
    {
    }
